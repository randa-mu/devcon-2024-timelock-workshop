...
export interface SimpleAuctionBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionEndBlock"
      | "auctionState"
...
export interface SimpleAuctionBase extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleAuctionBase;
  waitForDeployment(): Promise<this>;

  interface: SimpleAuctionBaseInterface;
