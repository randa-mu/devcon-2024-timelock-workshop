...
export interface DeployerTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "testDeterministicDeploy",
    values?: undefined
  ): string;
...
export interface DeployerTest extends BaseContract {
  connect(runner?: ContractRunner | null): DeployerTest;
  ...
  testDeterministicDeploy: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testDeterministicDeploy"
  ): TypedContractMethod<[], [void], "nonpayable">;
